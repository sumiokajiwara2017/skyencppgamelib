...
//--------3DScreenのセットアップ--------▽
	...
	//シザー矩形をシーングラフのルートに登録
	graphic::CScissorRectPtr spScissorRect = CScissorRectCreate_();
	spScissorRect->AddRect(  math::CBasicRectPtr( NEW math::CBasicRect( _WIN_W / 4 , _WIN_H / 4 , _WIN_W / 2 , _WIN_H / 2 ) ) );
	g_spScreen->GetScene()->m_spSceneGraph = spScissorRect;
