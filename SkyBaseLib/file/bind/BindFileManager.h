...
class CBindFileManager : public base::SkyObject
{
...
public:
	...
	/// 
	/// </summary>
	static void LoadAsync( const hash::CHashStringPtr &pPath , u32 category = bind::DEFAULT_CATEGORY_NO );
	...
	/// 同期ファイル読み込み
	/// </summary>
	static void Load( const hash::CHashStringPtr &pPath , u32 category = bind::DEFAULT_CATEGORY_NO );
	...
	/// ファイルをカテゴリで削除する
	/// </summary>
	static void Delete( u32 category = bind::DEFAULT_CATEGORY_NO );
...
private:
	...
	/// メンバ情報
	/// </summary>
	static CBindFileManagerMember *m_pMember;
};

//インスタンスアクセス文字列
#define CBindFileManagerInitialize_() sky::lib::file::CBindFileManager::Initialize()
#define CBindFileManager_             sky::lib::file::CBindFileManager
#define CBindFileManagerDispose_()    sky::lib::file::CBindFileManager::Dispose()
